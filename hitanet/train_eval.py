...
if __name__ == '__main__':
    ...
    path = '../data/Hitanet/'
    trianing_file = path + 'train_HT_777.pkl'
    validation_file = path + 'valid_HT_777.pkl'
    testing_file = path + 'test_HT_777.pkl'

    dict_file = '../data/dict_types_nomedi_mimic_240408_clinic_3_years.pkl'
